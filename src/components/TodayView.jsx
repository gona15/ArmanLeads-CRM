...
export default function TodayView({ followupsDue, draftsInProgress, recentlyAdded, onSelectLead }) {
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      <div>
        <h1 className="font-serif text-3xl sm:text-4xl text-[#12283C] leading-tight tracking-tight">Today</h1>
        <p className="text-sm text-[#8A8574] mt-1.5">Everything that needs you right now — nothing else.</p>
      </div>
