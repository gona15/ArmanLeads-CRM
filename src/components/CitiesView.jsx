...
export default function CitiesView({ cityGroups, activeCity, completedCities, onSetActiveCity, onMarkComplete, onReopenCity, onViewCity }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-serif text-3xl sm:text-4xl text-[#12283C] leading-tight tracking-tight">Cities</h1>
        <p className="text-sm text-[#8A8574] mt-1.5">Work one market at a time — wrap one up, move to the next.</p>
      </div>
